 ...
 * @package Sassy Starter
 */
function sassy_starter_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'sassy_starter_custom_header_args', array(
		'default-image'          => '',
...
if ( ! function_exists( 'sassy_starter_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog
 *
 * @see sassy_starter_custom_header_setup().
 */
function sassy_starter_header_style() {
